...
function base64LoginResponse(requestInfo, entity, user, customTagReplacement, encryptThenSign) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var idpSetting, spSetting, id, metadata, nameIDFormat, selectedNameIDFormat, base, rawSamlResponse, nowTime, spEntityID, fiveMinutesLaterTime, fiveMinutesLater, now, acl, authnStatement, tvalue, template, context, privateKey, privateKeyPass, signatureAlgorithm, config, context;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    authnStatement = "<saml:AuthnStatement AuthnInstant=\"" + now + "\" SessionIndex=\"" + id + "\"><saml:AuthnContext><saml:AuthnContextClassRef>urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport</saml:AuthnContextClassRef></saml:AuthnContext></saml:AuthnStatement>";
                    tvalue = {
                        ID: id,
                    ...
                    if (idpSetting.loginResponseTemplate && customTagReplacement) {
                        ...
                        context = libsaml_1.default.defaultLoginResponseTemplate.context.repeat(1);
                        if (requestInfo !== null) {
                            tvalue.InResponseTo = requestInfo === null || requestInfo === void 0 ? void 0 : requestInfo.extract.request.id;
                        }
                        else {
                            // remove InResponseTo attribute when requestInfo is empty
                            context = context.replace(/InResponseTo="\{InResponseTo\}"/g, "");
                        }
                        rawSamlResponse = libsaml_1.default.replaceTagsByValue(context, tvalue);
                    }
